...
import {
  AddressTranslator, //   Godwoken as GodwokenRpcHandler,
...
export class Godwoken {
  ...
  constructor(provider: providers.Web3Provider) {
    ...
    // this._godwokenRpcHandler = new GodwokenRpcHandler(
  ...
  async withdraw(
    ...
    // const layer2EthLock = this._addressTranslator.getLayer2EthLockHash(
    //   ethAddress,
    // )
    ...
    // const HARDCODED_CAPACITY = BigNumber.from(500).mul(
    ...
    // const result = await this._godwokenRpcHandler.submitWithdrawalRequest(
    //   withdrawalRequest,
    // )
